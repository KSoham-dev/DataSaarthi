    ...
    <div class="container mt-5">
        <div id="loading-overlay" class="loading-overlay hidden">
            <div class="overlay-content">
                ...
                <h5 class="mt-2">Removing file...</h5>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-8 col-lg-12">
                <div class="card p-4" :class="{ 'pt-0': store.tableData.length > 0 }"
                    ...
                    <div class="drop-area p-5 text-center border rounded-3"
                        ...
                        @drop.prevent="handleDrop" @click="openFileDialog" v-if="!store.cur_file_id">
                    ...
                    <div v-if="store.cur_file_id" :class="{ 'mt-4': store.tableData.length === 0 }">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <button @click="deleteFile" type="button" class="btn-close"
                                    aria-label="Remove"></button>
                            </li>
                        </ul>
                    </div>
...
onMounted(() => {
    ...
    store.pageNo = 1; // Reset page number on mount
});
